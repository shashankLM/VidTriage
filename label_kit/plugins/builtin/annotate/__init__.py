...
:class:`~label_kit.view.tools.ToolResult`; this plugin decides what it means:
...
:class:`~label_kit.plugins.models.Capability`, so a newly registered adapter
    ...
    def _prompt_for_label(self) -> None:
        ...
        if known:
            label, accepted = QInputDialog.getItem(
                ctx.app.window, "label-kit — Label",
