...
:class:`~vidtriage.plugins.runner.InferenceRunner` serialises calls per model
...
against :class:`~vidtriage.plugins.models.Capability`, not against this class.
"""
...
_DOWNLOAD_HINT = (
    "Download a SAM checkpoint into ~/.vidtriage/weights/ — for example:\n"
...
class SamModel(InferenceModel):
    ...
    parameters = (
        ParamSpec(
            ...
            help="Leave blank to auto-detect in ~/.vidtriage/weights/",
        ),
        ParamSpec(
